...
export const initialChapters: Chapter[] = [
  {
    id: 'ch-1',
    chapterNumber: 1,
    title: 'The First Hello Beneath the Rain',
    date: 'October 14, 2021',
    location: 'Hyde Park, London',
    description: 'We met by the Serpentine as soft autumn drizzle fell over London. A shared umbrella, two piping hot cappuccinos, and a conversation that stretched for hours until the city streetlights flickered awake.',
  ...
  },
  {
    ...
    description: 'Navigating 3,500 miles and a 5-hour time zone difference. We created our late-night tea ritual on FaceTime, reading poetry aloud and syncing movie timestamps so we could laugh together at the exact same frame.',
  ...
  },
  {
    ...
    description: 'Stepping off the plane and seeing each other after five long months. Walking hand-in-hand along the Bosphorus strait at sunset, listening to the evening adhan echo across ancient minarets.',
  ...
  },
  {
    ...
    description: 'As dozens of hot air balloons drifted into the sunrise sky, Mumu slipped the velvet ring box into Sofs’ hand. Surrounded by soft morning light and quiet prayers, we said yes to forever.',
