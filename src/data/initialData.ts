...
export const initialProfiles: { sofs: PartnerProfile; mumu: PartnerProfile } = {
  sofs: {
    ...
    name: 'Sofs',
    nickname: 'My Star',
    avatar: 'https://plus.unsplash.com/premium_photo-1725075087077-4a904603f416?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    location: 'London, UK',
    timezone: 'GMT+0',
